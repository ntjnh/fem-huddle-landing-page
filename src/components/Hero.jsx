            ...
            <div className="container mx-auto">
                <div className="flex flex-wrap items-center text-center lg:text-left">
                    <div className="px-5 md:px-0 lg:pl-5 lg:pr-20 lg:w-[46%]">
                        ...
                        <p className="text-cyan-975 text-base md:mx-auto md:text-lg md:w-[75%] lg:mx-0 lg:w-auto">Huddle re-imagines the way we build communities. You have a voice, but so does your audience. Create connections with your users as you engage in genuine discussion.</p>
